...
public class AttrsUtil {
    ...
    public static Attrs getAttrs(Context context, AttributeSet attributeSet) {
        ...
        attrs.todayLunarTextColor = ta.getColor(R.styleable.NCalendar_todayLunarTextColor, context.getResources().getColor(R.color.todaySolarTextColor));
        ...
        attrs.todayBgColor = ta.getColor(R.styleable.NCalendar_todayBgColor, 0);
