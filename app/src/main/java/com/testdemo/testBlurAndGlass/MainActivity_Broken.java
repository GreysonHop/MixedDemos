...
public class MainActivity_Broken extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_broken);
    ...
    private void initView() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MainActivity_Broken.this, "Button onClick", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void refreshDate() {
        ...
        listView.setAdapter(new SampleAdapter(MainActivity_Broken.this, android.R.layout.simple_list_item_1, items));
