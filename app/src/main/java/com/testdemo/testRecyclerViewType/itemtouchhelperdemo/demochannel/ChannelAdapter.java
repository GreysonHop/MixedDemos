package com.testdemo.testRecyclerViewType.itemtouchhelperdemo.demochannel;
...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
                ...
                holder.tvBtnEdit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (!isEditMode) {
                            ...
                            holder.tvBtnEdit.setText("finish");
                        } else {
                            cancelEditMode((RecyclerView) parent);
                            holder.tvBtnEdit.setText("edit");
                        }
                    }
                });
                return holder;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            ...
            if (isEditMode) {
                headerHolder.tvBtnEdit.setText("finish");
            } else {
                headerHolder.tvBtnEdit.setText("edit");
            }
        }
    }
